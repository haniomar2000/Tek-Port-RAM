...
set rc [catch {
  ...
  set_property webtalk.parent_dir {C:/Users/HANIO/Tek Port RAM/Tek Port RAM.cache/wt} [current_project]
  set_property parent.project_path {C:/Users/HANIO/Tek Port RAM/Tek Port RAM.xpr} [current_project]
  set_property ip_repo_paths {{c:/Users/HANIO/Tek Port RAM/Tek Port RAM.cache/ip}} [current_project]
  set_property ip_output_repo {{c:/Users/HANIO/Tek Port RAM/Tek Port RAM.cache/ip}} [current_project]
  add_files -quiet {{C:/Users/HANIO/Tek Port RAM/Tek Port RAM.runs/synth_1/RAM.dcp}}
